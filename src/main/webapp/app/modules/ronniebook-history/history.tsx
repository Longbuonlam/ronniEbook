  ...
  return (
    <div className="book-container">
            ...
            {favouriteBooks.map(book => (
              ...
              >
                ...
                <button
                  ...
                  aria-label={`Xóa ${book.title} khỏi lịch sử đọc`}
                >
      ...
      <ConfirmationModal
        ...
        message="Bạn có chắc muốn xóa cuốn sách này khỏi lịch sử đọc không?"
      />
