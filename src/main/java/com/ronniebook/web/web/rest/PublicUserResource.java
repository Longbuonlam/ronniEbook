...
public class PublicUserResource {
    ...
    public PublicUserResource(UserSearchRepository userSearchRepository, UserService userService, UserProfileService userProfileService) {
    ...
    public ResponseEntity<UserDTO> updateUser(@PathVariable(value = "id", required = false) final String id, @RequestBody UserDTO userDTO) {
        ...
        User existingUser = userProfileService.findOneById(id).orElseThrow();
        Optional<UserDTO> result = userProfileService.update(existingUser, userDTO);
    ...
    public UserDTO getUser(@PathVariable String id) {
        ...
        return userProfileService.findOneById(id).map(UserDTO::new).orElseThrow();
    }
}
